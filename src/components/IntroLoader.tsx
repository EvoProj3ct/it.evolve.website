        ...
        <AnimatePresence>
            {show && (
                ...
                >
                    {/* TENDA TOP */}
                    <motion.div
                        className="absolute left-0 top-0 h-1/2 w-full bg-[#CDE8D1]"
                        initial={{ y: "0%" }}
                    ...
                    {/* TENDA BOTTOM */}
                    <motion.div
                        className="absolute left-0 bottom-0 h-1/2 w-full bg-[#CDE8D1]"
                        initial={{ y: "0%" }}
                        animate={{ y: phase === "reveal" ? "105%" : "0%" }}
                        transition={{
                            duration: CURTAIN_DURATION_S,
                    ...
                    <div className="absolute left-1/2 top-1/2 w-[420px] max-w-[70vw] -translate-x-1/2 -translate-y-1/2">
                        ...
                        >
                            {/* Fase 1: fill */}
                            <motion.div
                                className="absolute left-0 top-0 h-full bg-[#72C94F]/90"
                                initial={{ width: "0%" }}
                                animate={{ width: "100%" }}
                            ...
                            {/* Fase 2: split */}
                            <motion.div
                                className="absolute left-1/2 top-0 h-full bg-[#72C94F]/90"
