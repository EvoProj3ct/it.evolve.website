              ...
              <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8">
                <div className="flex min-h-16 flex-col items-center justify-center gap-2">
                  ...
                  <div className="flex h-14 items-center justify-center sm:h-16 md:h-20">
                    <Image src="/logo-bcc.png" alt="BCC Paliano" width={260} height={102} className="max-h-14 w-auto object-contain drop-shadow-sm sm:max-h-16 md:max-h-20" priority />
                  </div>
                </div>
                <div className="flex min-h-16 flex-col items-center justify-center gap-2">
                  <span className="text-[0.62rem] font-semibold uppercase tracking-[0.22em] text-teal-700">Realizzato da</span>
                  <div className="flex h-14 items-center justify-center sm:h-16 md:h-20">
                    <Image src="/logo_nero.png" alt="Evolve" width={260} height={102} className="max-h-12 w-auto object-contain drop-shadow-sm sm:max-h-14 md:max-h-16" priority />
                  </div>
                </div>
              </div>
            </div>
