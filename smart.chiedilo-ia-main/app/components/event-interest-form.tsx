  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6 sm:space-y-8" noValidate>
      ...
      <div className="rounded-2xl border border-emerald-200 bg-emerald-50/70 p-4 text-sm leading-relaxed text-zinc-700 sm:p-5">
        Inserisci nome, cognome ed email. Il numero di telefono è facoltativo e serve solo se preferisci lasciare anche un contatto diretto.
      </div>
      ...
      >
        {submitting ? "Invio in corso..." : "Salva contatto e consensi"}
      </button>
